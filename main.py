...
# ==========================================
TOKEN = "8796935612:AAGWyt-7PoUqUZegltx5lw4vg5lARh6UpD0"
                ...
                if messages and messages[0]['id'] != last_msg_id:
                    ...
                    try:
                        ...
                        if detail_res.status_code == 200:
                            ...
                            # InlineKeyboardMarkup তৈরি করতে হবে (telebot নয়, তাই আমরা ডিকশনারি ব্যবহার করছি)
...
# ==========================================
# বাকি সব ফাংশন (পুরাতন) - সংক্ষেপে এখানে রাখা হলো
# ==========================================
...
# ==========================================
# Core parsing & monitoring functions
# ==========================================
...
# ==========================================
# Service & Language detection helpers
# ==========================================
...
def _handle_message_inner(msg):
    ...
    if chat_id in user_states and not is_main_cmd:
        ...
        # All state handlers are present in full original code
        pass
...
def handle_callback(call):
    ...
    # ---- Admin callbacks (full original) ----
        ...
        edit_message(chat_id, msg_id, render_body_text("📂 Upload numbers .txt file."))
        ...
        edit_message(chat_id, msg_id, render_body_text("🌐 StexSMS"), reply_markup=stex_control_keyboard())
    elif data == "voltx_control":
        edit_message(chat_id, msg_id, render_body_text("⚡ Voltx"), reply_markup=voltx_control_keyboard())
    elif data == "manage_fj":
        edit_message(chat_id, msg_id, render_body_text("🔗 Force Join"), reply_markup=fj_settings_keyboard())
    elif data == "manage_admins":
        edit_message(chat_id, msg_id, render_body_text("👥 Admins"), reply_markup=admin_settings_keyboard())
    elif data == "manage_otp_groups":
        edit_message(chat_id, msg_id, render_body_text("🛡 OTP Groups"), reply_markup=otp_groups_list_keyboard())
    elif data == "manage_panels":
        edit_message(chat_id, msg_id, render_body_text("⚙️ Panels"), reply_markup={"inline_keyboard": [[{"text": "API", "callback_data": "manage_api_panels"}, {"text": "Auto Captcha", "callback_data": "manage_cpt_panels"}], [{"text": "Back", "callback_data": "system_settings"}]]})
    elif data == "manage_api_panels":
        edit_message(chat_id, msg_id, render_body_text("API Panels"), reply_markup=typed_panels_list_keyboard("API Panel"))
    elif data == "manage_cpt_panels":
        edit_message(chat_id, msg_id, render_body_text("Auto Captcha Panels"), reply_markup=typed_panels_list_keyboard("Auto Captcha Panel"))
    elif data == "dxa_control":
        edit_message(chat_id, msg_id, render_body_text("🕹 DXA"), reply_markup=dxa_control_keyboard())
    elif data == "manage_w_methods":
        edit_message(chat_id, msg_id, render_body_text("💳 Methods"), reply_markup=w_methods_keyboard())
    elif data == "menu_design_list":
        edit_message(chat_id, msg_id, render_body_text("🎨 Menus"), reply_markup=menu_design_list_keyboard())
    elif data == "manage_emojis":
        edit_message(chat_id, msg_id, render_body_text("✨ Emojis"), reply_markup=emoji_settings_keyboard())
